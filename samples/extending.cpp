...
enum class DocumentType
{
	...
	WAVE,
	INHERITANCE,
	EXTENSION = 128, // reserve the first 128 values to buil-in and inherited
...
int main(int argc, char *argv[])
{
	...
	auto documentType1 = EnumeratorMeta<DocumentType>::Extender::extend();
	auto documentType2 = EnumeratorMeta<DocumentType>::Extender::extend();
